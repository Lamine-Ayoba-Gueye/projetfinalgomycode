                            ...
                            <div className="card bg-light d-flex flex-fill">
                                <div className="card-body pt-0">
                                    <div className="row mt-3">
                                        <div className="col-7">
                                            <h2 className="lead"><b><font style={{ verticalAlign: 'inherit' }}><font style={{ verticalAlign: 'inherit' }}></font></font></b> <font style={{ verticalAlign: 'inherit' }}><font style={{ verticalAlign: 'inherit' }}>{engin.nom}</font></font></h2>
